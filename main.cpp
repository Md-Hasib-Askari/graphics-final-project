...
public:
    ...
    void update() {
        ...
        if (toggleNuke) {
            ...
            // =====> Particles
            if (!resetParticles) { // Particles are moving up
...
void displayScene(int sceneKey) {
    ...
    case 2:
        ...
        if (Scene2::instance == nullptr) { // Only set the instance if it's not already set
    ...
    case 5:
        ...
        if (Scene5::instance == nullptr) { // Only set the instance if it's not already set
